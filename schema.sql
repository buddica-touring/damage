-- ============================================================
-- BUDDICA TOURING 車両デジタルツイン スキーマ
...
CREATE TABLE vehicle_twins (
  ...
  store           TEXT NOT NULL DEFAULT 'takamatsu',  -- takamatsu / sapporo
  plate           TEXT NOT NULL,              -- 高松500さ23-45
...
('V-001', 'takamatsu', '高松500さ23-45', 'ALPHARD', 2020, 'パールホワイト', 'returning', 'R-127', '山田 太郎',
  '[
...
('V-002', 'takamatsu', '高松500さ67-89', 'HIACE', 2019, 'ホワイト', 'out', 'R-128', '鈴木 花子',
  '[{"id":"dmg010","location":"リアバンパー左","type":"scratch","severity":"minor","desc":"横8cm","since_event_id":null}]',
  52300, 98),

('V-003', 'takamatsu', '高松500さ11-22', 'PRIUS', 2022, 'ブラック', 'out', 'R-129', '佐藤 一郎',
  '[]',
  18700, 45),

('V-004', 'takamatsu', '高松500さ33-44', 'VELLFIRE', 2021, 'パールホワイト', 'ready', NULL, NULL,
  '[
...
('V-005', 'takamatsu', '高松500さ55-66', 'NOAH', 2020, 'シルバー', 'maintenance', NULL, NULL,
  '[
